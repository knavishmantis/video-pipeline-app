  ...
  return (
    <div style={{ padding: '0 4px', maxWidth: '860px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <div style={{ padding: '12px 16px', background: 'var(--col-clips-dim)', border: '1px solid var(--col-clips-border)', borderRadius: '8px' }}>
          <p style={{ fontSize: '12px', color: 'var(--text-secondary)', lineHeight: '1.55', margin: 0 }}>
            <span style={{ color: 'var(--col-clips)', fontWeight: '700' }}>⚠️ Primary Reference</span>{' '}
            This is your primary reference document for clip styling and formatting.
